                ...
                <article className="prose prose-slate dark:prose-invert max-w-none bg-card p-8 rounded-xl border shadow-sm">
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            By creating an account or using this platform, you agree to be bound by these Terms of Service.
                            If you do not agree with these terms, you may not use the service.
                        </p>
                    </section>

                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">2. Description of Service</h2>
                        <p className="text-muted-foreground leading-relaxed">
                            Our platform provides a digital note-taking and study assistance tool designed primarily for university students. The platform allows users to create notes, store definitions, organize study material, and improve their academic workflow.
                            Features and functionality may change over time as the platform improves.
                        </p>
                    </section>

                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">3. User Accounts</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">4. Acceptable Use</h2>
                        <p className="text-muted-foreground leading-relaxed">
                            You agree not to:
                        </p>
                        <ul className="list-disc pl-5 text-muted-foreground space-y-2 mt-2">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">5. User Content</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">6. Paid Subscriptions</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">7. Cancellation</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">8. Service Availability</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">9. Limitation of Liability</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">10. Changes to Terms</h2>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <section className="mb-6">
                        <h2 className="text-xl font-bold mb-4 text-foreground">11. Contact</h2>
                        <p className="text-muted-foreground leading-relaxed">
